...
public class Register_Page_Elements1 {
	...
	public void Registration_Step1() throws InterruptedException {
		...
		WebElement yourelement= driver_Register_Page_Elements.findElement(Register_Page_Privacy_checkbox);
		...
		Thread.sleep(6000);
		WebElement Register_button= driver_Register_Page_Elements.findElement(Register_Page_Register_Button);
	...
	public void click_continue_on_reg_page2() throws InterruptedException{
		WebDriverWait wait = new WebDriverWait(driver_Register_Page_Elements, 20);
		wait.until(ExpectedConditions.visibilityOfElementLocated(Register_page_2_Continue));
		WebElement Reg_page_2_continue_button= driver_Register_Page_Elements.findElement(Register_page_2_Continue);
		JavascriptExecutor executor = (JavascriptExecutor)driver_Register_Page_Elements;
		executor.executeScript("arguments[0].click();", Reg_page_2_continue_button);
...
public void voucher_process() throws InterruptedException
{
	...
	WebElement Voucher_button= driver_Register_Page_Elements.findElement(By.xpath("//*[@id=\"app\"]/div[2]/div/div/div/div[2]/div[2]/div[1]/form/button[1]/div"));
	JavascriptExecutor executor = (JavascriptExecutor)driver_Register_Page_Elements;
	executor.executeScript("arguments[0].click();", Voucher_button);
	...
	Thread.sleep(1000);
	WebElement Voucher_add_button= driver_Register_Page_Elements.findElement(By.xpath("//*[@id=\"app\"]/div[2]/div/div/div/div[2]/div[2]/div[1]/form/button[1]/div/span"));
	executor.executeScript("arguments[0].click();", Voucher_add_button);
	
	Thread.sleep(3000);
	WebElement Zero_pounds= driver_Register_Page_Elements.findElement(By.xpath("//*[@id=\"app\"]/div[2]/div/div/div/div[2]/div[2]/div[1]/form/section[1]/div/div[2]/label[1]"));
	executor.executeScript("arguments[0].click();", Zero_pounds);
