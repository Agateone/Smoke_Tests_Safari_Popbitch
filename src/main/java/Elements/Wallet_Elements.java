...
public class Wallet_Elements {
	...
	public void Click_On_popbitch_staging_agate_poster() throws InterruptedException	
	{
		Thread.sleep(20000);
		WebDriverWait wait = new WebDriverWait(driver_Popbitch_Wallet_Elements_staging, 20);
		WebElement element= wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"agateposter\"]")));				
