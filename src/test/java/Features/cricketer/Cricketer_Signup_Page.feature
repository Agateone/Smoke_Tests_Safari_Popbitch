...
#****
#POPSMO01 
Scenario: Successful signup from cricketer FUN  
Given I am a user of Axate and I am on the registration page through cricketer FUN "browser"
...
#****
#POPSMO02 
Scenario: Successful signup from cricketer Wallet staging
Given I am a user of Axate and I am on the registration page through cricketer Wallet homepages "browser"
When I enter all the required details on step one and click on continue
And top up with a valid card in steptwo with three pounds and click on continue
...
#****
#POPSMO03
Scenario: Successful registration through login page cricketer
Given I am a user of Axate and I am on the login page through cricketer FUN "browser"
...
Scenario: Successful signup from cricketer FUN with three poundss "browser"
...
#POPSMO08
Scenario: Successful signup from cricketer FUN with five pounds
Given I am a user of Axate and I am on the registration page through cricketer FUN "browser"
When I enter all the required details on step one and click on continue
And I click on five pounds on regpage two
And enter valid card details and click on continue
...
#POPSMO09
Scenario: Successful signup from cricketer FUN with eight pounds
Given I am a user of Axate and I am on the registration page through cricketer FUN "browser"
When I enter all the required details on step one and click on continue
And I click on eight pounds on regpage two
And enter valid card details and click on continue
...
Given I am a user of Axate and I am on the registration page through cricketer FUN "browser"
When I enter all the required details on step one and click on continue
And I skip the payment and navigating to a premium article on cricketer
