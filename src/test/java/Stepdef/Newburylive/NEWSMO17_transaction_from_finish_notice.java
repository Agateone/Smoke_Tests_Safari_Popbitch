...
public class NEWSMO17_transaction_from_finish_notice {
	WebDriver driver;
	...
	public void full_article_is_displayed_to_the_user() throws InterruptedException {
		...
		WebDriverWait wait = new WebDriverWait(driver, 20);
		WebElement paragraph = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[5]/div[2]/div/div[2]/div[6]/div[1]/div/p[24]")));				
	   Boolean displayed = driver.findElement(By.xpath("/html/body/div[5]/div[2]/div/div[2]/div[6]/div[1]/div/p[24]")).isDisplayed();
	   ...
	   Assert.assertTrue(Para.contains("They want services"));	
