...
public class NEWSMO18_transaction_from_authorise_charge_notice{
	WebDriver driver;
	...
	public void full_article_is_displayed_to_the_user() throws InterruptedException {
		...
		WebDriverWait wait = new WebDriverWait(driver, 20);
		WebElement paragraph = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[5]/div[2]/div/div[2]/div[6]/div[1]/div/p[12]")));				
	   Boolean displayed = driver.findElement(By.xpath("/html/body/div[5]/div[2]/div/div[2]/div[6]/div[1]/div/p[12]")).isDisplayed();
	   ...
	   Assert.assertTrue(Para.contains("Nevertheless, a council repor"));	
