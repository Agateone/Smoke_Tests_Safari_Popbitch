...
public class CRISMO19_Transaction_from_new_pub_notice {
WebDriver driver;
	...
	@When("navigate to a premium article on cricketer")
	@Test(priority=99)
	public void navigate_to_a_premium_article_on_cricketer() throws InterruptedException {
		driver.navigate().to("https://www.thecricketer.com/Topics/premimum_features/englishman_in_antigua_johnny_grave_is_in_charge_of_west_indies_cricket_trying_to_lead_a_renaissance_and_beating_joe_roots_men_did_no_harm.html");
	}
	...
	public void free_point_is_detucted_by_twentyfivep() throws InterruptedException {
		...
		String expected_free_point="1.50";
	...
	public void full_article_is_displayed_to_the_user() throws InterruptedException {
		...
		WebDriverWait wait = new WebDriverWait(driver, 20);
		WebElement paragraph = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[3]/div/div/div/div[1]/div[2]/div[3]/p[34]")));				
	   Boolean displayed = driver.findElement(By.xpath("/html/body/div[3]/div/div/div/div[1]/div[2]/div[3]/p[34]")).isDisplayed();
	   ...
	   Assert.assertTrue(Para.contains("Yes, because we firmly believe playing"));	
