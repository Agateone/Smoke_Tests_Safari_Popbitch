...
public class REASMO17_transaction_from_finish_notice {
	WebDriver driver;
	...
	public void full_article_is_displayed_to_the_user() {
		WebDriverWait wait = new WebDriverWait(driver, 20);
		WebElement paragraph = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[5]/div[1]/main/div/article/div/div[2]/div[1]/div[2]/div/div[2]/p[14]")));				
	   Boolean displayed = driver.findElement(By.xpath("/html/body/div[5]/div[1]/main/div/article/div/div[2]/div[1]/div[2]/div/div[2]/p[14]")).isDisplayed();
	   ...
	   Assert.assertTrue(Para.contains("What will happen, of course,"));	
