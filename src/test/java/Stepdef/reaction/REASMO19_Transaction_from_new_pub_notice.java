...
public class REASMO19_Transaction_from_new_pub_notice {
WebDriver driver;
	...
	@Test(priority=103)
	public void free_point_is_detucted_by_twentyp() throws InterruptedException {
		Wallet_Elements w1 = new Wallet_Elements(driver);
		w1.Click_On_popbitch_staging_agate_poster();
	...
	public void full_article_is_displayed_to_the_user() throws InterruptedException {
		//WebDriverWait wait = new WebDriverWait(driver, 20);
		Thread.sleep(3000);
		WebElement paragraph = driver.findElement(By.xpath("/html/body/div[6]/div[1]/main/div/article/div/div[2]/div[1]/div[2]/div/div[2]/p[20]"));				
	   Boolean displayed = driver.findElement(By.xpath("/html/body/div[6]/div[1]/main/div/article/div/div[2]/div[1]/div[2]/div/div[2]/p[20]")).isDisplayed();	   
