...
public class GRASMO18_transaction_from_authorise_charge_notice{
	WebDriver driver;
	...
	public void click_ok_on_the_authorise_charge_notice() throws IOException, InterruptedException {
		driver.findElement(By.xpath("/html/body/div[7]/div/div/div[3]/div[2]/button[2]")).click();
		Thread.sleep(2000);
		//driver.switchTo().frame("__cmpLocator");
		//driver.findElement(By.xpath("/html/body/div[8]/div/div[1]/button")).click();
	...
	public void wallet_balance_is_detucted_by_twentyfivep() throws InterruptedException {
		...
		w1.Click_On_popbitch_staging_agate_poster();
		String actual_current_balance=w1.current_balance();
		String expected_current_balance="9.80";
		Assert.assertEquals(actual_current_balance, expected_current_balance);
	}
...
//cant test on grantham as there is a problem with the button
/*	
	@Then("full article is displayed to the user")
	@Test(priority=87)
	public void full_article_is_displayed_to_the_user() throws InterruptedException {
		//Thread.sleep(1000);				
		//driver.findElement(By.xpath("/html/body/div[9]/div/div/div[3]/div[2]/button[2]")).click();
	   ...
	   Boolean displayed = driver.findElement(By.xpath("/html/body/div[5]/div[2]/div/div[1]/article/div[3]/div[3]/p[9]")).isDisplayed();
	   ...
	   Assert.assertTrue(Para.contains("We get all kinds of items that end up in lost property and we’ve even had racing pigeons, but a crab is def"));	
