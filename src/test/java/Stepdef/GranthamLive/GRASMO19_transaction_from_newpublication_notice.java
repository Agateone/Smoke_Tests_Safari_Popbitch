...
public class GRASMO19_transaction_from_newpublication_notice {
WebDriver driver;
	...
	@When("navigate to a premium article on grantham")
	@Test(priority=99)
	public void navigate_to_a_premium_article_on_grantham() throws InterruptedException {
	...
	public void opt_just_charge_me_on_the_newpublication_notice_and_click_ok() throws InterruptedException, IOException {
		WebDriverWait wait = new WebDriverWait(driver, 20);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[7]/div/div/div[3]/div[2]/button[2]")));	
