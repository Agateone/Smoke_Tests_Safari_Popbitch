...
public class EXASMO19_Transaction_from_New_pub {
WebDriver driver;
	...
	@When("navigate to a premium article on examiner")
	@Test(priority=99)
	public void navigate_to_a_premium_article_on_examiner() throws InterruptedException {
