...
public class EXASMO18_transaction_from_auhtorise_charge_notice {
	WebDriver driver;
	...
	public void i_am_a_user_of_Axate_and_I_am_on_the_registration_page_through_popbitch_FUN(String browser) throws InterruptedException, IOException {
			...
			//chrome
					...
					Reach_First_Use_Elements popbitch_first_use_elements= new Reach_First_Use_Elements(driver);
					popbitch_first_use_elements.Click_On_Reach_First_Use_CreateWallet();
					WebDriverWait wait = new WebDriverWait(driver, 20);
					wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("email")));	
					String reg_Page_url= driver.getCurrentUrl();
					if(reg_Page_url.contains("https://account.agate.io/my-agate/sign-up?"))
	...
	public void free_point_is_detucted_by_twentyfivep() throws InterruptedException {
		...
		String expected_free_point="75p";
		 System.out.print(actual_free_point);
	...
	public void full_article_is_displayed_to_the_user() throws InterruptedException {		
		WebDriverWait wait = new WebDriverWait(driver, 20);
		WebElement paragraph = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/main/article/div[3]/div/div[1]/div[2]/p[13]")));				
	    Boolean displayed = driver.findElement(By.xpath("/html/body/main/article/div[3]/div/div[1]/div[2]/p[13]")).isDisplayed();	   
	    ...
	    Assert.assertTrue(Para.contains("is will include a 90 da"));	
