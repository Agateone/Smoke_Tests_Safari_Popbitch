...
public class SCISMO19_transaction_from_new_pub_notice {
WebDriver driver;
	...
	@When("navigate to a premium article on scifinow")
	@Test(priority=99)
	public void navigate_to_a_premium_article_on_scifinow() throws InterruptedException {
