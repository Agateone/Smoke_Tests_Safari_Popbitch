...
public class Scifi_Live {
	...
	public void i_am_a_user_of_Axate_and_I_am_on_the_registration_page_through_popbitch_FUN(String browser) throws Throwable {
		...
		if(browser.equalsIgnoreCase("firefox")) {
			...
			Popbitch_Signup_Page_driver.get("https://www.newburytoday.co.uk/news/news/27964/no-quantitative-need-for-additional-convenience-stores-in-thatcham.html");
			Scifi_First_Use_Notice popbitch_first_use_elements= new Scifi_First_Use_Notice(Popbitch_Signup_Page_driver);
		...
		//safari
				...
				try {
					Popbitch_Signup_Page_driver.get("https://www.examinerlive.co.uk/news/man-groped-schoolgirl-half-age-14655205");					
				}
				catch(Exception e)
				{
		...
		//chrome
				...
				Popbitch_Signup_Page_driver.get("https://www.scifinow.co.uk/interviews/scary-stories-to-tell-in-the-dark-director-andre-ovredal-on-horror-anticipation-and-smuggling-illegal-vhs-tapes/");
	...
	public void i_get_a_funded_axate_wallet_with_one_pound_in_it() throws Throwable {
		...
		String expected_current_balance="1s.00";
