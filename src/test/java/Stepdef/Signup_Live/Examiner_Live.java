...
public class Examiner_Live {
	...
	public void i_am_a_user_of_Axate_and_I_am_on_the_registration_page_through_popbitch_FUN(String browser) throws Throwable {
		...
		if(browser.equalsIgnoreCase("firefox")) {
			...
			Reach_First_Use_Elements popbitch_first_use_elements= new Reach_First_Use_Elements(Popbitch_Signup_Page_driver);
	...
	public void navigated_to_the_same_article() throws Throwable {
	    ...
	    String expected_url = "https://www.examinerlive.co.uk/news/man-groped-schoolgirl-half-age-14655205";
