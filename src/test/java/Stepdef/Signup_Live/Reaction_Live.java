...
public class Reaction_Live {
	...
	public void i_am_a_user_of_Axate_and_I_am_on_the_registration_page_through_popbitch_FUN(String browser) throws Throwable {
		...
		if(browser.equalsIgnoreCase("firefox")) {
			...
			Popbitch_Signup_Page_driver.get("https://reaction.life/labours-last-gasp/");
		...
		//chrome
				...
				Popbitch_Signup_Page_driver.get("https://reaction.life/labours-last-gasp/");
				Reaction_first_use_notice reaction = new Reaction_first_use_notice(Popbitch_Signup_Page_driver);
	...
	public void navigated_to_the_same_article() throws Throwable {
	    ...
	    String expected_url = "https://reaction.life/labours-last-gasp/";
